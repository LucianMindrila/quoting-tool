...
export const EDGING_COST_PM   = 3;
export const VAT              = 0.20;
export const DELIVERY_CHARGE  = 75;
export const V_GROOVE_SURCHARGE = 35;

// Egger group → sheet price
export const EGGER_GRP_PRICE = { 2:65, 3:77, 4:82, 5:90, 6:96, 7:99, 8:101, 9:110, 10:116 };
...
export const TM_DECORS = [
  { id:'tm-W1100',   code:'W1100 TM',   name:'Alpine White',         tmtype:'TM',   price:144 },
  { id:'tm-U201',    code:'U201 TM',    name:'Pebble Grey',          tmtype:'TM',   price:144 },
  { id:'tm-U250',    code:'U250 TM',    name:'Caramel Beige',        tmtype:'TM',   price:144 },
  { id:'tm-U750',    code:'U750 TM',    name:'Taupe Grey',           tmtype:'TM',   price:144 },
  { id:'tm-U960',    code:'U960 TM',    name:'Onyx Grey',            tmtype:'TM',   price:144 },
  { id:'tm-U740',    code:'U740 TM',    name:'Dark Taupe',           tmtype:'TM',   price:144 },
  { id:'tm-U398',    code:'U398 TM',    name:'Dark Berry',           tmtype:'TM',   price:144 },
  { id:'tm-U590',    code:'U590 TM',    name:'Deep Blue',            tmtype:'TM',   price:144 },
  { id:'tm-U968',    code:'U968 TM',    name:'Carbon Grey',          tmtype:'TM',   price:144 },
  { id:'tm12-H1228', code:'H1228 TM12', name:'Anthracite Abano Ash', tmtype:'TM12', price:144 },
  { id:'tm12-H1227', code:'H1227 TM12', name:'Brown Abano Ash',      tmtype:'TM12', price:144 },
  { id:'tm12-H3041', code:'H3041 TM12', name:'Natural Eucalyptus',   tmtype:'TM12', price:144 },
  { id:'tm28-U999',  code:'U999 TM28',  name:'Black',                tmtype:'TM28', price:167 },
];
...
MFC_DECORS.forEach(d => {
  const base = { sheetW:2800, sheetH:2070, cutCost:16 };
  MATERIALS['eg18-' + d.id] = {
    ...base,
...
PS_GLOSS_DECORS.forEach(d => {
  MATERIALS['eg-' + d.id] = {
    sheetW:2800, sheetH:2070, cutCost:16,
...
Object.assign(MATERIALS, {
  'free-issued-2800': { name:'Free Issued Board 2800×2070mm', display:'Free Issued 2800×2070', price:0,  sheetW:2800, sheetH:2070, cutCost:16 },
  'free-issued-3050': { name:'Free Issued Board 3050×1220mm', display:'Free Issued 3050×1220', price:0,  sheetW:3050, sheetH:1220, cutCost:12 },
  'free-issued-2440': { name:'Free Issued Board 2440×1220mm', display:'Free Issued 2440×1220', price:0,  sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-6':            { name:'MDF 6mm (2440×1220)',  display:'MDF 6mm',   price:15, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-9':            { name:'MDF 9mm (2440×1220)',  display:'MDF 9mm',   price:20, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-12':           { name:'MDF 12mm (2440×1220)', display:'MDF 12mm',  price:22, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-15':           { name:'MDF 15mm (2440×1220)', display:'MDF 15mm',  price:25, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-18-2440':      { name:'MDF 18mm (2440×1220)', display:'MDF 18mm',  price:28, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-22':           { name:'MDF 22mm (2440×1220)', display:'MDF 22mm',  price:32, sheetW:2440, sheetH:1220, cutCost:8  },
  'mdf-25':           { name:'MDF 25mm (2440×1220)', display:'MDF 25mm',  price:35, sheetW:2440, sheetH:1220, cutCost:8  },
  'mrmdf-6':          { name:'MR MDF 6mm (2440×1220)',  display:'MR MDF 6mm',  price:18, sheetW:2440, sheetH:1220, cutCost:8  },
  'mrmdf-9':          { name:'MR MDF 9mm (2440×1220)',  display:'MR MDF 9mm',  price:24, sheetW:2440, sheetH:1220, cutCost:8  },
  'mrmdf-12':         { name:'MR MDF 12mm (2440×1220)', display:'MR MDF 12mm', price:27, sheetW:2440, sheetH:1220, cutCost:8  },
  'mrmdf-18-2440':    { name:'MR MDF 18mm (2440×1220)', display:'MR MDF 18mm', price:36, sheetW:2440, sheetH:1220, cutCost:8  },
  'mrmdf-25':         { name:'MR MDF 25mm (2440×1220)', display:'MR MDF 25mm', price:45, sheetW:2440, sheetH:1220, cutCost:8  },
  // V Groove Panelling — MR MDF 2440×1220 + £35 grooving surcharge
  'vgroove-len-9':    { name:'V Groove Panelling 9mm — Groove along length (2440mm)',  display:'V Groove 9mm — along 2440',  price:24+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-len-12':   { name:'V Groove Panelling 12mm — Groove along length (2440mm)', display:'V Groove 12mm — along 2440', price:27+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-len-18':   { name:'V Groove Panelling 18mm — Groove along length (2440mm)', display:'V Groove 18mm — along 2440', price:36+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-len-25':   { name:'V Groove Panelling 25mm — Groove along length (2440mm)', display:'V Groove 25mm — along 2440', price:45+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-wid-9':    { name:'V Groove Panelling 9mm — Groove along width (1220mm)',   display:'V Groove 9mm — along 1220',  price:24+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-wid-12':   { name:'V Groove Panelling 12mm — Groove along width (1220mm)',  display:'V Groove 12mm — along 1220', price:27+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-wid-18':   { name:'V Groove Panelling 18mm — Groove along width (1220mm)',  display:'V Groove 18mm — along 1220', price:36+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
  'vgroove-wid-25':   { name:'V Groove Panelling 25mm — Groove along width (1220mm)',  display:'V Groove 25mm — along 1220', price:45+V_GROOVE_SURCHARGE, sheetW:2440, sheetH:1220, cutCost:8 },
});
